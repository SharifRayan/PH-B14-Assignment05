...
function Footer() {
  return (
    <footer id="contact" className="mt-[80px] border-t border-[#EEF1F5] bg-white">
      <div className="mx-auto grid max-w-[1248px] gap-12 px-6 py-[70px] md:grid-cols-[1.8fr_1fr_1fr_1fr] lg:px-0">
        <div>
          ...
          <div className="mt-[22px] flex gap-[18px] text-[10px] font-medium text-[#526078]">
      ...
      <div className="border-t border-[#EEF1F5]">
        <div className="mx-auto flex max-w-[1248px] flex-col gap-3 px-6 py-[20px] text-[10px] text-[#A1ADBE] sm:flex-row sm:items-center sm:justify-between lg:px-0">
